defmodule SymphonyElixir.AgentRunner do
  ...
  defp run_codex_turns(workspace, issue, codex_update_recipient, opts) do
    ...
    do_run_claude_turns(workspace, issue, codex_update_recipient, opts, issue_state_fetcher, 1, max_turns)
  end

  defp do_run_claude_turns(workspace, issue, codex_update_recipient, opts, issue_state_fetcher, turn_number, max_turns) do
